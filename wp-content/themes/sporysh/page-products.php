...
function applyUrlFilter() {
  ...
  const f = params.get('filter') || params.get('cat') || params.get('category');
...
(function() {
  ...
  function buildFullCatalog() {
    ...
    // Re-apply any active filter/search now that the full catalog groups exist —
    // otherwise a filter set before this ran (e.g. via ?filter= URL param) never
    // reaches these groups since they didn't exist yet when _applyFilters() ran.
